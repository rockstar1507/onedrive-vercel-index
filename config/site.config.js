...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'https://zw816-my.sharepoint.com/personal/percystellar_zw816_onmicrosoft_com',
  ...
  title: "Abhi's OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: 'https://zw816-my.sharepoint.com/personal/percystellar_zw816_onmicrosoft_com/Documents',
